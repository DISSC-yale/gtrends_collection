...
4. An output directory (`data` or `data_yearly`) to write results to.
...
On top of those components, the `.github/workflows/weekly_collection.yaml` and `.github/workflows/yearly_collection.yaml` files defines
GitHub actions used to perform regular updates.
