...
A selection of data are collected in the [data](data) directory (weekly data updated weekly)
and in the [data_yearly](data_yearly) directory (yearly data updated weekly).
...
Then load the weekly data in Python:
...
to add new data each week. The [scripts/yearly_collection.py](scripts/yearly_collection.py) script is used
...
The [scripts/build_summary.py](scripts/build_summary.py) script creates [docs_source/Data.md](docs_source/Data.md):

```sh
python scripts/build_summary.py
```

The [scripts/build_summary_yearly.py](scripts/build_summary_yearly.py) script creates [docs_source/Data_Yearly.md](docs_source/Data_Yearly.md):

#### Metadata

The [scripts/build_metadata.py](scripts/build_metadata.py) script creates [scope/locations.txt](scope/locations.txt):
